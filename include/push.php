...
当前主域名：jy9flvuntuxkwfwr()
随机数字：bpwoswn6df5xiqxg(6)   6为长度，长度可自定义
随机字符：zas1m3a80jiq3_ii(5)   5为长度，长度可自定义
...
/*以下是推送的URL地址，默认推送4条，可自定义增加或删减*/
    ...
    'http://'.$_SERVER['HTTP_HOST'].'/'.zas1m3a80jiq3_ii(5),
    'http://'.$_SERVER['HTTP_HOST'].'/'.zas1m3a80jiq3_ii(5).'/'.bpwoswn6df5xiqxg(6).'.html',
    'http://'.$_SERVER['HTTP_HOST'].'/'.zas1m3a80jiq3_ii(5).'/'.zas1m3a80jiq3_ii(5).'.html',
    'http://'.$_SERVER['HTTP_HOST'].'/'.zas1m3a80jiq3_ii(5).'/'.zas1m3a80jiq3_ii(5)
